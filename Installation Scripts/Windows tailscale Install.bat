...
:gotPrivileges
	...
	echo ---------------------------------------------------
	echo NOTICE: RUNNING TAILSCALE INSTALL
    ...
    echo.
    echo Setting chocolatey cache location back to default, if chocolatey is installed
    echo.

	choco config set --name cacheLocation --value "C:\Users\%USERNAME%\AppData\Local\Temp\chocolatey"
